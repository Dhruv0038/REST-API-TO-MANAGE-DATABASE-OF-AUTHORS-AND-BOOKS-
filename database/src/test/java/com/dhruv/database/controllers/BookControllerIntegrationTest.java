package com.dhruv.database.controllers;
...
import com.dhruv.database.services.BookService;
...
public class BookControllerIntegrationTest {
    ...
    public void testThatCreateBookReturnsHttpStatus201Created() throws Exception{
        ...
        mockMvc.perform(
                MockMvcRequestBuilders.put("/books/978-1-2345-6789-0" + bookDto.getIsbn())
    ...
    @Test
    public void testThatListBookReturnsHttpStatus200OkWhenBookExists() throws Exception{
        BookEntity testBookEntityA = TestDataUtil.createTestBookEntityA(null);
        bookService.createUpdateBook(testBookEntityA.getIsbn(), testBookEntityA);
    ...
    @Test
    public void testThatListBookReturnsHttpStatus404WhenBookDoesntExists() throws Exception{
        BookEntity testBookEntityA = TestDataUtil.createTestBookEntityA(null);
    ...
    @Test
    public void testThatUpdateBookReturnHttpStatus200Ok() throws Exception{
        BookEntity testBookEntityA = TestDataUtil.createTestBookEntityA(null);
    ...
    @Test
    public void testThatUpdatesBookReturnsUpdatedBook() throws Exception{
        BookEntity testBookEntityA = TestDataUtil.createTestBookEntityA(null);
        BookEntity savedBookEntity = bookService.createUpdateBook(
                testBookEntityA.getIsbn(), testBookEntityA
        );
    ...
    public void testThatDeleteNonExistingBookReturnsHttpStatus204NoContent() throws Exception {
        mockMvc.perform(
                MockMvcRequestBuilders.delete("/books/kishrhei")
                        .contentType(MediaType.APPLICATION_JSON)
